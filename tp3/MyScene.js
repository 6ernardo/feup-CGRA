...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.componentIntensity = 0.3; // Exp 1
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.55, 0.3, 0.07, 1.0)
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.componentIntensity, this.componentIntensity, this.componentIntensity, 1.0); // Exp 1
